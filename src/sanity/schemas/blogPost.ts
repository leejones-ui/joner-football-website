export default {
  ...
  fields: [
    ...
    { name: 'body', title: 'Body content', type: 'text', rows: 12, group: 'content', description: 'Main blog article content. Plain text is safest for the current live blog template.' },
    { name: 'richBody', title: 'Rich body content', type: 'array', group: 'content', of: [{ type: 'block' }, { type: 'imageWithMeta' }], description: 'Future rich editor field. The current live blog template still uses Body content above.' },
    { name: 'category', title: 'Category', type: 'string', group: 'content', options: { list: ['coaching', 'training', 'news', 'app'] } },
