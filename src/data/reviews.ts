...
// Every entry below is transcribed from the canonical Joner App Testimonials Bank.
...
export const jonerReviews: JonerReview[] = [
  {
    ...
    product: 'Team Training: Scanning, Awareness & Possession',
    date: '2026-02-20',
    dateLabel: '20 February 2026',
    source: 'Joner Football App',
    sourceDetail: 'Verified video comment',
  ...
  },
  {
    ...
    name: 'Matthew B.',
    audience: 'Coach',
    product: 'Joner Football App, Coaches area',
    date: '2026-05-22',
    dateLabel: '22 May 2026',
    source: 'Joner Football App',
    sourceDetail: 'Community review posted in response to Lee’s public feedback request',
  ...
  },
  {
    ...
    name: 'Matthew B.',
    audience: 'Coach',
    product: 'Joner Football App, Coaches Only',
    date: '2026-06-01',
    dateLabel: 'June 2026',
    source: 'Joner Football App',
    sourceDetail: 'Verified Coaches Only community comment',
  ...
  },
  {
    ...
    dateLabel: 'June 2026',
    source: 'Joner Football App',
    sourceDetail: 'Verified video comments',
  ...
  },
  {
    ...
    name: 'Ollie',
    audience: 'Player',
    product: 'Dribbling Program, Session 1',
    date: '2026-07-25',
  ...
  },
  {
    ...
    source: 'Joner Football App',
    sourceDetail: 'Member direct message, name shortened for privacy',
  ...
  },
  {
    ...
    product: 'Joner Football App, Max Annual',
    date: '2026-08-10',
    dateLabel: '10 August 2026',
    source: 'Joner Football App',
    sourceDetail: 'Verified community comment from a live Max Annual member',
