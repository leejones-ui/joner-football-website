...
const campDocs = [
  ...
  },
  {
    ...
    _type: 'camp',
    title: 'Sydney July Camp ft Miguel Grande',
    slug: { current: 'sydney-july-2026' },
    status: 'open',
    heroKicker: 'Biggest Camp Of The Year',
    heroHeadline: 'Sydney July Camp ft Miguel Grande',
    heroSubtitle: 'Joner Football Sydney July Camp 2026 at Rydalmere Park with Coach Joner and guest coach Miguel Grande from Grande Sports Miami.',
    heroImageUrl: '/images/camps/sydney-2026/photos/lee-miguel-coaching.jpg',
    ...
    stripePaymentLink: 'https://app.jonerfootball.com',
    description: 'Joner Football Sydney July Camp 2026 at Rydalmere Park with Coach Joner and guest coach Miguel Grande from Grande Sports Miami. July 14 to 16. Ages 8 to 18. Limited spots.',
    ...
    images: {
      heroPoster: '/images/camps/sydney-2026/photos/lee-miguel-coaching.jpg',
      gallery: [
        '/images/camps/sydney-2026/photos/lee-miguel-coaching.jpg',
