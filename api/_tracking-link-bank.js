...
export const TRACKING_DESTINATIONS = Object.freeze({
  ...
  // App collection deep links for Brevo campaign tiles. A campaign thumbnail should
  // land on the content itself so the reader sees the preview, not a generic page.
  // Permalinks verified live against the Uscreen publisher API on 2026-09-19.
  'app-pro-training-series': 'https://app.jonerfootball.com/programs/pro-training-series-coach-joner',
  'app-session-planning': 'https://app.jonerfootball.com/programs/collection-gnkimdxgcla',
  'app-coaching-the-coaches': 'https://app.jonerfootball.com/programs/collection-hmchbz0bats',
  'app-coaches-extras': 'https://app.jonerfootball.com/programs/collection-vt0re_4htdk',
  'app-free-to-watch': 'https://app.jonerfootball.com/programs/freefootballtraining',
  'app-follow-along': 'https://app.jonerfootball.com/programs/followalong',
  'app-weak-foot': 'https://app.jonerfootball.com/programs/weak-foot',
  'app-score-more-goals': 'https://app.jonerfootball.com/programs/collection-8ysig5wzu0u',
  'app-hq-sessions': 'https://app.jonerfootball.com/programs/collection-c9j6zaeykrs',
  'app-voice-over-series': 'https://app.jonerfootball.com/programs/collection-g9zdkztzagw',
  'app-ages-6-9': 'https://app.jonerfootball.com/programs/ages6to9',
  'app-ages-10-13': 'https://app.jonerfootball.com/programs/ages10to13',
  'app-ages-14-plus': 'https://app.jonerfootball.com/programs/ages14',
  'app-gk-shot-stopping': 'https://app.jonerfootball.com/programs/collection-lo_tdfdxfgy',
  'app-kinstretch': 'https://app.jonerfootball.com/programs/kinstretch',
  'app-shooting-drills': 'https://app.jonerfootball.com/programs/beginnershooting',
