import { addPhaseTwoThree, buildReconciliation, config, fetchMetaReport, fetchReliableSales, fetchUscreenInvoices, previousWindow, resolveWindow, authorised } from './_meta-uscreen-reconciliation.js'
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const [meta, invoices, sales, previousMeta, previousInvoices] = await Promise.all([
