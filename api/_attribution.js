...
export function decodeUscreenSource(value) {
  ...
  return {
    ...
    ttclid: clean(packed.get('x'), 500),
    msclkid: clean(packed.get('y'), 500),
...
export function extractAttribution(data) {
  ...
  return {
    ...
    ttclid: clean(firstValue(data, 'ttclid') || decoded.ttclid, 500),
    msclkid: clean(firstValue(data, 'msclkid') || decoded.msclkid, 500),
