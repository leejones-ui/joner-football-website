import { listWebhookFailures, replayWebhookFailure, reconcileAuthoritativePayments, getAnonymousAggregates } from './_reliability-ledger.js'
...
export default async function handler(req, res) {
  ...
  try {
    if (req.method === 'GET') return json(res, 200, { success: true, failures: await listWebhookFailures(), aggregates: await getAnonymousAggregates() })
